#!/usr/bin/env python
"""Generate appendix-ready learning curves from existing fold history CSV files."""
...
def generate_for_results_root(results_root: Path) -> list[Path]:
    ...
    for history_path in history_paths:
        ...
        output_path = history_path.with_name(f"{fold_name}_learning_curves.png")
...
def main() -> None:
    ...
    outputs = generate_for_results_root(args.results_root)
