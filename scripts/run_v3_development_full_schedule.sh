...
mkdir -p chapter4_results/development_v3_full_schedule
python scripts/run_case_5fold_isolated.py \
  ...
  --fold_limit 1 \
  --output_dir chapter4_results/development_v3_full_schedule/proposed_artifact_mix \
  2>&1 | tee chapter4_results/development_v3_full_schedule.log
